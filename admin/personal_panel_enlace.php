...
<span id="listar_personal" class="button mediano azul" onclick="listarPotencialesEvio()">LISTAR POTENCIALES USUARIOS</span>
...
<div id="formulario_potencialEditar"></div> 
 <div id="formularioBuscadorPotencial"  >
    <form name="frmbusqueda2" onkeypress="buscarPotencialUsuario();" class="contacto">
...
<div id="listarPotencialesEvio" class="listarPotencialesEvio"></div>
<div id="formulario_envioDJ">
    <form action="registrando_Envio_dj.php" name="form_personal_utc" method="post" class="contacto" enctype="multipart/form-data" >
            <table border="0">
			 <tr>
                <td>DNI:</td>
            ...
            <tr>
              ...
              <tr>
                <td>SEXO:</td>
                <td><select id ='sexo_usuario_p65_col' name='sexo_usuario_p65_col' class='select'>
