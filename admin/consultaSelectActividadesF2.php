...
where co.idcomponentes_bd=$idp  AND f.idformatos_bd=2   
 group by nombre_actividad_bd ;";
$consultafechaguia=dime($cadena);
echo"ACTIVIDADES:<br>
    <select id ='idactividades_bd' name='idactividades_bd' class='select' onchange='mostrarSelectIndicadoresF2()' >
	...
	echo"</select></br>
<div id='selectActividadesF2' name='selectIndicadoresF2'></div>  
<div id='selectIndicadoresF2' name='selectIndicadoresF2'>dd</div>  ";
