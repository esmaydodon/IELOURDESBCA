...
IF($idp!=='0'){
$cadena="
select * from formatos_indicadores_bd as fi inner join 
...
where co.idcomponentes_bd=$idp  AND f.idformatos_bd=3   
 group by nombre_actividad_bd ;";
$consultafechaguia=dime($cadena);
echo"ACTIVIDADES:<br>
    <select id ='idactividades_bd' name='idactividades_bd' class='select' onchange='mostrarSelectIndicadoresF3()' >
	...
	echo"</select></br>
<div id='selectActividadesF3' name='selectIndicadoresF3'></div>  
<div id='selectIndicadoresF3' name='selectIndicadoresF3'>dd</div>  ";
