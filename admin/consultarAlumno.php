...
<a style='float:left;text-decoration:underline;cursor:pointer;' onclick=\"AlumnoPaginacion('1')\">Primero</a> ";
if($PagAct>1) echo "<a style='text-decoration:underline;cursor:pointer;' onclick=\"AlumnoPaginacion('$PagAnt')\">Anterior</a> ";
echo "<spam style='float:left;'><strong>AlumnoPaginacion ".$PagAct."/".$PagUlt."</strong></spam>";
if($PagAct<$PagUlt)  echo " <a style='float:left;text-decoration:underline;cursor:pointer;' onclick=\"AlumnoPaginacion('$PagSig')\">Siguiente</a> ";
echo "<a style='float:left;text-decoration:underline;cursor:pointer;' onclick=\"AlumnoPaginacion('$PagUlt')\">Ultimo</a></div>";
echo "
<div></td></tr>            
</table>  </div>
";
