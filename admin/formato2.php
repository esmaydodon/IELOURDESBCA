...
where  
  f.idformatos_bd=2  order  by co.idcomponentes_bd;");
    echo"<select id ='idcomponentes_bd' name='idcomponentes_bd' class='select' onchange='mostrarSelectActividadesF2()' >
	...
	echo"</select></br>
<div id='selectActividadesF2' name='selectActividadesF2'></div> ";
?>

<a href="formato2.php"><img src="../images/32x32/accept.png" width="32" height="32" /></a>
<a href="formato2LimpiarSesiones.php"><img src="../images/32x32/remove.png" width="32" height="32" /></a></label>
</div>
...
<img src='../images/productonoagregado.gif' border='0' title='Seleccionar'></a><br>";	
        ...
        echo"Idactividades:".$d['idactividades_bd'].",actividades:".$d['nombre_actividades_bb']." <br>"; 
...
?>
      ...
      <input type="hidden" id="idformatos_bd" name="idformatos_bd" value="2" />
